...
namespace ViewModel
{
    ...
    public class DispatcherHelper
    {
        ...
        public static void DoEvents()
        {
            try
            {
                ...
                DispatcherOperation exitOperation =
                    DispatcherHelper.UI_Dispatcher.BeginInvoke(DispatcherPriority.Background, exitFrameCallback,
                        nestedFrame);
        ...
        {
            UI_Dispatcher.BeginInvoke(new Action(() => { action(obj); }), DispatcherPriority.Normal);
        }

        public static void DoMenthodByDispatcher(Action action)
        {
            UI_Dispatcher.BeginInvoke(new Action(() => { action(); }), DispatcherPriority.Normal);
        }
    }
}